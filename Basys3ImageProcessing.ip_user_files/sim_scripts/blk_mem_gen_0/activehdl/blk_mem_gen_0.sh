...
#
# Script generated by Vivado on Sat Apr 27 02:31:21 +0200 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/FPGA/Basys3ImageProcessing/Basys3ImageProcessing.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
